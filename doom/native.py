...
LIBRARY=Path(os.environ.get('DOOM_KERNEL_PATH',str(ROOT/'outputs/doom'/('libneural.dll' if sys.platform=='win32' else ('libneural.dylib' if sys.platform=='darwin' else 'libneural.so')))))
